...
if($definitiva>=3){
 ...
 if($definitiva>=1 and $definitiva<3 ){
  $mensaje = "Desempeño bajo";
}

else {

  if($definitiva>=3 and $definitiva<4 ){
    $mensaje = "Desempeño Basico";
  }
}
  if($definitiva>=4 and $definitiva<4.5 ){
    $mensaje = "Desempeño Alto";
  }
  else {

    if($definitiva>=4.5 and $definitiva<5 ){
      $mensaje = "Desempeño Superior";
    }
  }
  else{
    $mensaje = "definitiva NO corresponde";
  }
...
<html lang="en">
    ...
    <tr>
      <td>Escala Ncional:</td>
      <td><?php mostrar_mensaje($mensajeEscalaNacional);?></td>
    </tr>
