...
function calcular_valor_absoluto($numero){
...
//Entrada
$numero=ingresar_dato("textNumero");

//Proceso
$valorAbsoluto=calcular_valor_absoluto($numero);
...
<html lang="en">
    ...
    <tr>
      <td>Número:</td>
      <td><?php mostrar_mensaje($numero); ?></td>
    </tr>
    <tr>
      <td>Valor Absoluto:</td>
      <td><?php mostrar_mensaje($valorAbsoluto); ?></td>
    </tr>
                                            </thead>
                                            <tbody>
                                    </div>
