                        ...
                        <div class="col-lg-6">
                            <div class="panel panel-default">
                                ...
                                <div class="panel-body">
                                    <div class="row">
                                        <div class="col-lg-6">
                                            <form role="form" method="post" action="salario.php">
                                                <div class="form-group">
                                                    <label>Documento:</label>
                                                    <input name="textDocumento" class="form-control"
                                                    placeholder="Numero de documento de identidad">
                                                </div>
                                                <div class="form-group">
                                                    <label>Nombre:</label>
                                                    <input name="textNombre" class="form-control" placeholder="Nombre y apellidos del obrero">
                                                </div>
                                                <div class="form-group">
                                                    <label>Sueldo Base:</label>
                                                    <input name="textSueldoBase" class="form-control" placeholder="ingrese sueldo base">
                                                </div>
                                                <div class="form-group">
                                                    <label>Numero de Horas Extras</label>
                                                    <input name="textNumeroHorasExtras" class="form-control" placeholder="ingrese numero de horas extras">
                                                </div>
